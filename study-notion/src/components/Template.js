...
const Template = ({title, desc1, desc2, image, formType, setLogged}) => {
  ...
  return (
    <div className='flex flex-wrap lg:justify-between justify-center w-11/12 max-w-[860px] py-12 mx-auto gap-12'>

        <div className='w-11/12 max-w-[350px] lg:order-1 order-2' >
            <h1
            ...
            border text-slate-800 px-[12px] py-[8px] gap-x-2 mt-6 '>
                <FcGoogle/>
